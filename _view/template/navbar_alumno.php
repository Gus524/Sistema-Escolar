        ...
        <ul class="navbar-nav justify-content-end flex-grow-1">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="Horario">Comprobante Horario</a>
              </li>
              <li>
                <a class="dropdown-item" href="Calificaciones">Calificaciones</a>
              </li>
            </ul>
          </li>
          <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="HistorialAcademico">Historial Academico</a>
                </li>
              <li>
                <a class="dropdown-item" href="EstadoGeneral">Estado General</a>
              </li>
            </ul>
          </li>
          <li class="nav-item dropdown">
